...
This is an example of a JWZ generated by an identity wallet as a response to the auth request generated as a response to a ZK request posed by a Verifier, similar to the one performed inside the [Verifier Setup Tutorial](/docs/verifier/verification-library/verifier-set-up.md).
...
```json
{
  ...
  "from": "did:iden3:uptick:origin:2qMY7xymaXWdFDt74xR1z8mYrzSYBC1VeSWw6ZhcSP",
  "to": "did:iden3:uptick:origin:2qDyy1kEo2AYcP3RT4XGea7BtxsY285szg6yP9SPrs",
  "body": {
    "did_doc": {
      "@context": ["https://www.w3.org/ns/did/v1"],
      "id": "did:iden3:uptick:origin:2qMY7xymaXWdFDt74xR1z8mYrzSYBC1VeSWw6ZhcSP",
      "service": [
        {
          "id": "did:iden3:uptick:origin:2qMY7xymaXWdFDt74xR1z8mYrzSYBC1VeSWw6ZhcSP#push",
